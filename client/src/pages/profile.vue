<template>
    <div class="profile-page">
        <div class="profile-container">
            ...
            <div class="profile-actions" v-if="!userStore.isEditing">
...
import EditProfileForm from '~/features/profile/ui/EditProfileForm.vue';
...
const userInfo = computed(() => {
    ...
    return {
        ...
        winRate: calculateWinRate(user.value)
    };
});
...
function calculateWinRate(user: IUser) {
